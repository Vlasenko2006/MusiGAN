...
def compute_chunkwise_stats_loss(fake_music, real_music, num_chunks=1000, lambda_mean=0.1, lambda_std=0.1, lambda_max=0.005):  # num_chunks = 200
    ...
    for epoch in range(start_epoch, epochs + 1):
        ...
        for batch_idx, data in enumerate(tqdm(train_loader, desc="Training")):
            ...
            for _ in range(1):
                ...
                g_loss = (g_loss_reconstruction + beta * g_loss_kl + g_loss_gan + g_loss_stats + lambda_fm * fm_loss) / accumulation_steps
                g_loss.backward()
