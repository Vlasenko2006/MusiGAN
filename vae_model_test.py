...
class VariationalAttentionModel(nn.Module):
    ...
    def forward(self, x):
        ...
        corrcoef_fake_music = torch.corrcoef(torch.stack([fake_music_g[0, ...].flatten(), fake_music_g[1, ...].flatten()]))
        print("correlation after attention reconstruction", corrcoef_fake_music[0, 1])
...
if __name__ == "__main__":
    ...
    # Generate random noise as input [batch_size, n_channels, seq_len]
    random_noise = torch.randn(batch_size, n_channels, seq_len)
    ...
    outputs = model(random_noise)

    # # Extract and display outputs
    # reconstructed_bands, mu, logvar, fake_music_g = outputs
    # print("Reconstructed Bands:", reconstructed_bands)
    # print("Mu:", mu)
    # print("LogVar:", logvar)
    # print("Fake Music:", fake_music_g)
